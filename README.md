...
### Metrics
```text
14833 number of properties
10175 number of functions
8753 number of classes
217 number of packages
3440 number of kt files
```


### Complexity Report
```text
256555 lines of code (loc)
157057 source lines of code (sloc)
114657 logical lines of code (lloc)
71897 comment lines of code (cloc)
24434 cyclomatic complexity (mcc)
20158 cognitive complexity
