...
class AtomicIncrementorTest {
    ...
    fun `do not increment counter when condition is false`() {
        ...
        assertEquals(0, incrementor.getSharedCounter())
    }
    ...
    fun `increment counter concurrently`() = runBlocking {
        ...
        assertEquals(1000000, incrementor.getSharedCounter())
    }
    ...
    fun `increment counter with mixed conditions`() = runBlocking {
        ...
        assertEquals(500000, incrementor.getSharedCounter())
    }
}
