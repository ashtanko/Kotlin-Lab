...
abstract class MinInsertionsPalindromeTest<out T : MinInsertionsPalindrome>(private val strategy: T) {
    ...
    fun `min insertions test`(s: String, expected: Int) {
        val actual = strategy.minInsertions(s)
