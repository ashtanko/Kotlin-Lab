...
abstract class ShipWithinDaysTest<out T : ShipWithinDays>(private val strategy: T) {
...
class ShipWithinDaysBSTest : ShipWithinDaysTest<ShipWithinDays>(ShipWithinDaysBS())
