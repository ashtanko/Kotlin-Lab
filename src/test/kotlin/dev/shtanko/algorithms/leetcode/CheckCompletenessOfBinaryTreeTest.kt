...
abstract class CheckCompletenessOfBinaryTreeTest<out T : CheckCompletenessOfBinaryTree>(private val strategy: T) {
    ...
    fun `is complete tree test`(root: TreeNode?, expected: Boolean) {
        val actual = strategy.isCompleteTree(root)
