...
abstract class MinimumAverageDifferenceTest<out T : MinimumAverageDifference>(private val strategy: T) {
...
class MinimumAverageDifferenceBruteForceTest :
    MinimumAverageDifferenceTest<MinimumAverageDifference>(MinimumAverageDifferenceBruteForce())

class MinimumAverageDifferencePrefixSumTest :
    MinimumAverageDifferenceTest<MinimumAverageDifference>(MinimumAverageDifferencePrefixSum())
