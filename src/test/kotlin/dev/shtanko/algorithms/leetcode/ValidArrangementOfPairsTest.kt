...
abstract class ValidArrangementOfPairsTest<out T : ValidArrangementOfPairs>(private val strategy: T) {
    ...
    fun minimumTimeTest(pairs: Array<IntArray>, expected: Array<IntArray>) {
        val actual = strategy(pairs)
        assertThat(actual).isEqualTo(expected)
    }
}

class HierholzersAlgorithmTest : ValidArrangementOfPairsTest<ValidArrangementOfPairs>(HierholzersAlgorithm())
